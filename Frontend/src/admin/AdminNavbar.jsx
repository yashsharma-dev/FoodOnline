...
function AdminNavbar() {
  ...
  return (
    <>
      {/* <div className="relative  h-full min-h-screen w-3/12 font-[sans-serif]"> */}

      <div className=" antialiased bg-black w-full h-full min-h-screen text-slate-300 fixed py-4">
        <div className="grid grid-cols-12  gap-2 sm:gap-4 md:gap-6 lg:gap-10 xl:gap-14 max-w-7xl  px-2">
          <div id="menu" className="bg-white/10 col-span-3 rounded-lg p-4 ">
            ...
            <div id="menu" className="flex flex-col space-y-2 my-5">
              <Link to={"/admin_dashboard"} className="hover:bg-white/10 transition duration-150 ease-linear rounded-lg py-3 px-2 group">
              ...
              <Link to={"/products"} className="hover:bg-white/10 transition duration-150 ease-linear rounded-lg py-3 px-2 group">
                <div className="relative flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm hidden md:block">View Products</p>
                  </div>
